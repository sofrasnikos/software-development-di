...
do
	...
	time -v ../ngrams -i ../../datasets/small_static/small_static.init -q ../../datasets/small_static/small_static.work > small_static.out
	echo
	echo "--- Executing medium static ---"
	time -v ../ngrams -i ../../datasets/medium_static/medium_static.init -q ../../datasets/medium_static/medium_static.work > medium_static.out
	echo
	echo "--- Executing large static ---"
	time -v ../ngrams -i ../../datasets/large_static/large_static.init -q ../../datasets/large_static/large_static.work > large_static.out
